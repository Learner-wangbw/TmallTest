...
<div id="footer" class="footer" style="display: block;">
    ...
    <div class="workArea">
        <div class="tmall-ensure">
            <a href="#nowhere">
                <img src="${pageContext.request.contextPath}/img/fore/footer1.png">
                <img src="${pageContext.request.contextPath}/img/fore/footer2.png">
                <img src="${pageContext.request.contextPath}/img/fore/footer3.png">
                <img src="${pageContext.request.contextPath}/img/fore/footer4.png">
            </a>
        </div>
        ...
        <div class="tmall-desc">
            ...
            <dl>
                ...
                <dd><a href="#nowhere"><img src="${pageContext.request.contextPath}/img/fore/qr-code.png"></a></dd>
            </dl>
        </div>
    ...
    <div class="workArea">
        <img src="${pageContext.request.contextPath}/img/fore/tmall-cat.png" class="tmall-cat">
    </div>
        ...
        <div class="workArea">
            <div class="mui-global-fragment-load">
                ...
                <div class="footer-copyright">
                    ...
                    <a href="#nowhere"><img src="${pageContext.request.contextPath}/img/fore/police-icon.png">浙公网安备 33010002000120号</a>
                    <span>（浙）网械平台备字[2021]第00002号</span>
                    <div class="copyRightYear">© 2003-2021 TMALL.COM 版权所有</div>
                    <div>
                        <img src="${pageContext.request.contextPath}/img/fore/copyRight1.jpg">
                        <img src="${pageContext.request.contextPath}/img/fore/copyRight2.jpg">
                    </div>
                </div>
            </div>
