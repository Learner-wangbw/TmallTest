...
<div class="confirmPayPageDiv">
    <div class="confirmPayImageDiv">
        <img src="${pageContext.request.contextPath}/img/fore/comformPayFlow.png">
    ...
    <div class="confirmPayOrderDetailDiv">
        ...
        <table class="confirmPayOrderDetailTable">
            <tr>
                <td>订单编号：</td>
                <td>${order.order_code} <img width="23px" src="${pageContext.request.contextPath}/img/fore/confirmOrderTmall.png"></td>
            </tr>
            <tr>
                <td>卖家昵称：</td>
