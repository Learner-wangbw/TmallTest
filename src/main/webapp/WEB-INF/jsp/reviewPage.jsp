...
<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="${pageContext.request.contextPath}/img/product/${product.id}/1.jpg"></div>
        <div class="reviewProductInfoRightDiv">
            ...
            <div class="reviewProductInfoRightBelowDiv">
                <span class="reviewProductInfoRightBelowImg"><img src="${pageContext.request.contextPath}/img/fore/reviewLight.png"></span>
    ...
    <c:if test="${param.showonly!=true}">
        <div class="makeReviewDiv">
            <form method="post" action="${pageContext.request.contextPath}/doreview">
