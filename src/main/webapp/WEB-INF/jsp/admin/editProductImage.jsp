                                ...
                                <c:forEach items="${productImages}" var="pi">
                                    <tr>
                                        ...
                                        <td><img class="col-md-8"
                                                 src="${pageContext.request.contextPath}/img/product/${pi.product_id}/${pi.id%5==0?5:pi.id%5}.jpg"
                                                 onerror="this.src='../img/product/error.png'"></td>
                                        <td class="col-md-5">
                                            <form action="${pageContext.request.contextPath}/admin/updateProductImage" method="post"
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/admin/deleteProductImage?product_id=${pi.product_id}&id=${pi.id}"><span
