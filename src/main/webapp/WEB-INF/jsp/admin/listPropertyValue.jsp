...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a href="${pageContext.request.contextPath}/admin/listProduct?category_id=${product.category_id}" class="btn btn-success">返回上一页</a>
                </div>
            </div>
            <br>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${propertyValues}" var="pv">
                                        <tr>
                                            ...
                                            <td>${pv.value}</td>
                                            <td><a href="${pageContext.request.contextPath}/admin/editPropertyValue?id=${pv.id}"><span
                                                    class="glyphicon glyphicon-edit"></span></a></td>
                                            <td>
                                                <a href="${pageContext.request.contextPath}/admin/deletePropertyValue?id=${pv.id}&category_id=${product.category_id}"><span
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form action="${pageContext.request.contextPath}/admin/addPropertyValue" role="form" name="addPropertyValueForm">
