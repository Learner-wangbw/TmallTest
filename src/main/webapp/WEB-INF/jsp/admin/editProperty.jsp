...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a href="${pageContext.request.contextPath}/admin/listProperty?category_id=${category.id}" class="btn btn-success">返回上一页</a>
                </div>
            </div>
            <br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row col-lg-12">
                                <form action="${pageContext.request.contextPath}/admin/updateProperty" role="form">
