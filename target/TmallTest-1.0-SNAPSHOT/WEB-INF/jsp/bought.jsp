        ...
        <c:forEach items="${orders}" var="o">
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td colspan="2"><img width="13px" src="${pageContext.request.contextPath}/img/fore/orderItemTmall.png">天猫商场</td>
                    <td colspan="1">
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItems)}"
                                ...
                                <c:if test="${o.status=='waitConfirm'}">
                                    <a href="confirmPay?order_id=${o.id}">
                                        <button type="button" class="orderListItemConfirm">确认收货</button>
                                    </a>
                                </c:if>
