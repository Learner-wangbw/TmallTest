...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        分类管理
                        <small> - ${product.name} - id:${propertyValue.id} 属性值管理</small>
                    </h1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <a href="${pageContext.request.contextPath}/admin/listPropertyValue?product_id=${product.id}&category_id=${product.category_id}" class="btn btn-success">返回上一页</a>
                </div>
            </div>
            <br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row col-lg-12">
                                <form action="${pageContext.request.contextPath}/admin/updatePropertyValue" role="form">
