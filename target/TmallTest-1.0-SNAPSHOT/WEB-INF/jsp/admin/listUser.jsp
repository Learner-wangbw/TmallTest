                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-default">
                                <a href="${pageContext.request.contextPath}/admin/toAddUser">增加用户</a>
                            </button>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${users}" var="u">
                                        <tr>
                                            <td>${u.id}</td>
                                            <td>${u.name}</td>
                                            <td><a href="${pageContext.request.contextPath}/admin/editUser?id=${u.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                                            <td><a href="${pageContext.request.contextPath}/admin/deleteUser?id=${u.id}">删除</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
