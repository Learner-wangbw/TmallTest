                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <form action="${pageContext.request.contextPath}/admin/updateUser" role="form">
                                <input type="hidden" name="id" value="${user.id}">
                                <label>用户名：</label>
                                <input class="form-control" type="text" name="name" placeholder="请输入名称" value="${user.name}"
                                       onblur="if(this.value === '')this.value='${user.name}';" onclick="if(this.value === '${user.name}')this.value='';" >
                                <label>新密码：</label>
                                <input class="form-control" type="text" name="password" placeholder="请输入密码" value="${user.password}"
                                       onblur="if(this.value === '')this.value='${user.password}';" onclick="if(this.value === '${user.password}')this.value='';"><br>
