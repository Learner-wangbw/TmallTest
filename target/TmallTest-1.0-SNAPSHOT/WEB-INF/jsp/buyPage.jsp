...
<div class="buyPageDiv">
    <form action="createOrder" method="post">
        ...
        <div class="buyFlow">
            <img class="pull-left" src="${pageContext.request.contextPath}/img/fore/simpleLogo.png">
            <img class="pull-right" src="${pageContext.request.contextPath}/img/fore/buyflow.png">
            ...
            <div>
                ...
                <table class="addressTable">
                    <tr>
                        ...
                        <td><textarea name="address" placeholder="建议您如实填写详细收货地址，例如街栋名称，门牌号码，楼层和房间号等信息"></textarea></td>
                    </tr>
                    <tr>
                        <td>邮政编码</td>
        ...
        <div class="productList">
            ...
            <table class="productListTable">
                ...
                <tr>
                    <th colspan="2" class="productListTableFirstColumn">
                        <img class="tmallbuy" src="${pageContext.request.contextPath}/img/fore/tmallbuy.png">
                ...
                <c:forEach items="${orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemTR">
                        ...
                        <td class="orderItemProductInfo">
                            ...
                            <img src="${pageContext.request.contextPath}/img/fore/creditcard.png" title="支持信用卡支付">
                            <img src="${pageContext.request.contextPath}/img/fore/7day.png" title="消费者保障服务,承诺7天退货">
                            <img src="${pageContext.request.contextPath}/img/fore/promise.png" title="消费者保障服务,承诺如实描述">
            ...
            <div class="orderItemSumDiv">
                <div class="pull-left">
                    ...
                    <span>
                        <img class="leaveMessageImg" src="${pageContext.request.contextPath}/img/fore/leaveMessage.png">
                    </span>
