        ...
        <table class="cartProductTable">
            ...
            <tr>
                <th class="selectAndImage">
                    <img selectit="false" class="selectAllItem" src="${pageContext.request.contextPath}/img/fore/cartNotSelected.png">
                    全选
                ...
                <tr orderItemId="${oi.id}" class="cartProductItemTR">
                    <td>
                        <img selectit="false" orderItemId="${oi.id}" class="cartProductItemIfSelected"
                             src="${pageContext.request.contextPath}/img/fore/cartNotSelected.png">
                        <a style="display:none" href="#nowhere"><img src="${pageContext.request.contextPath}/img/fore/cartSelected.png"></a>
                        <img class="cartProductImg"
                             src="img/product/${oi.product.id}/1.jpg">
                    </td>
                    <td>
                        <div class="cartProductLinkOutDiv">
                            <a href="${pageContext.request.contextPath}/showProduct?product_id=${oi.product.id}"
